    ...
    const CERTIFICATE_CONFIG = {
        withPicture: {
            ...
            picture: {
                ...
                y: 758,      // Vertical position
                radius: 265, // Size of circular crop
                scale: 1     // Scale factor for picture size
            },
            // Name placement (x, y, font settings)
            name: {
                x: 805,      // Horizontal center position
                y: 1100,     // Vertical position
            ...
            signature: {
                x: 430,      // Always Start at x position == 760px
                y: 1525,     // Vertical position
                fontSize: 65,// Font size
                fontFamily: '"Segoe UI", Arial, sans-serif', // Font family
                color: '#c61716' // Text color
            }
        },
        withoutPicture: {
            ...
            name: {
                x: 805,      // Horizontal center position
                y: 870,      // Vertical position
                fontSize: 84,// Larger font size
                fontFamily: '"Segoe UI", Arial, sans-serif', // Font family
                color: '#ffffff' // Text color
            },
            // Signature placement (x, y, font settings)
            signature: {
                x: 430,      // Fixed horizontal position
                y: 1525,     // Vertical position
                fontSize: 65,// Slightly larger font size
                fontFamily: '"Segoe UI", Arial, sans-serif', // Font family
                color: '#c61716' // Text color
            }
        }
